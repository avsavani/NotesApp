    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(NotesActivity.this, NoteTakerActivity.class);
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.layout:
                        ...
                        Toast.makeText(NotesActivity.this, "Layout updated!", Toast.LENGTH_SHORT).show();
                        return true;
                    case R.id.pinned:
...
//                database.userDAO().insertUserNotesref(new_note);
        ...
        Toast.makeText(NotesActivity.this, "Cancelled!", Toast.LENGTH_SHORT).show();
